          ...
          <form id="contact-form" method="post" action="contact.php" role="form">
                    ...
                    <div className="controls">
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="form-group">
                                    ...
                                    <MDBInput label='Please enter your name *' className="form-control" id='form_name' type='text' />
                            ...
                            <div className="col-lg-6">
                                <div className="form-group">
                                    ...
                                    <MDBInput label='Please enter your company name' className="form-control" id='form_company' type='text' />
                                    <div className="help-block with-errors"></div>
                                </div>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col-lg-6">
                                <div className="form-group">
                                    ...
                                    <MDBInput label='Please enter your email *' className="form-control" id='form_email' type='email' />
                                    <div className="help-block with-errors"></div>
                                </div>
                            </div>
                            <div className="col-lg-6">
                                <div className="form-group">
                                    ...
                                    <MDBInput label='Please enter your phone' className="form-control" id='form_phone' type='tel' />
                                    <div className="help-block with-errors"></div>
                                </div>
                            </div>
                        </div>
                        <div className="form-group">
                            ...
                            <MDBTextArea label='Message' id='textAreaExample' rows={4} className="form-control" />
                            <div className="help-block with-errors"></div>
                        </div>
